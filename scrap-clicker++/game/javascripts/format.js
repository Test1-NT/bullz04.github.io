...
function format(amount, places = 3, placesUnder1000 = 1, notation = player.options.notation) {
    ...
    */
    ...
    if (notation === "standard") {
        ...
        let result2 = ((Math.floor((Math.max(AAA, 0))) % 3000000) > 6003) ? shortPrefixes1_1[Math.floor((Math.max(AAA, 0) / 3000)) % 10] + shortPrefixes1_2[Math.floor((Math.max(AAA, 0) / 30000)) % 10] + shortPrefixes1_3[Math.floor((Math.max(AAA, 0) / 300000)) % 10] + "MI" : (((Math.floor((Math.max(AAA, 0))) % 3000000) > 3003) ? "MI" : "")
        let result3 = ((Math.floor((Math.max(AAA, 0))) % 3000000000) > 6000003) ? shortPrefixes1_1[Math.floor((Math.max(AAA, 0) / 3000000)) % 10] + shortPrefixes1_2[Math.floor((Math.max(AAA, 0) / 30000000)) % 10] + shortPrefixes1_3[Math.floor((Math.max(AAA, 0) / 300000000)) % 10] + "MC" : (((Math.floor((Math.max(AAA, 0))) % 3000000000) > 3000003) ? "MC" : "")
        if (power.gte(3000000003)) return lol.toFixed(places) + "e" + power.toNumber().toLocaleString("en-US")
