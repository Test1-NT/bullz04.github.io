...
player = {
    ...
    challenge : {
        completions : [null, 0, 0, 0, 0]//unused
    }
}
...
function goldenScrapPrestige() {
    let pendingGoldenScrap = Decimal.round(Decimal.pow(player.scrap, 0.15))
...
function updateText() {
    ...
    document.getElementById("PendingGoldenScrapDisplay").innerHTML = format(Decimal.round(Decimal.pow(player.scrap, 0.15)))
};
